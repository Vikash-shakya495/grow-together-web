...
const { MongoNetworkError, MongoError, MongoNetworkTimeoutError } = require('mongodb');
...
function connectionFailureError(type, cause) {
    switch (type) {
        case 'error':
            const message = cause ? MongoError.buildErrorMessage(cause) : 'Unknown error';
            return new MongoNetworkError(message, { cause });
        case 'timeout':
